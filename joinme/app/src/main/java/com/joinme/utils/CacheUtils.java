...
public class  CacheUtils {
    ...
    public static final String DRAWABLE_KEY = "MuxistudioDrawable";
    ...
    public static void saveDrawableCache(String key,Drawable drawable){
        acache.put(key,drawable);
    }
    public static Drawable readDrawbleCache(String key){
        return acache.getAsDrawable(key);
    }
    public static void removeDrawableCache(String key){
        acache.remove(key);
    }
